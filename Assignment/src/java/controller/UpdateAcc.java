...
public class UpdateAcc extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
                String accID = request.getParameter("saccID");
        AccDAO dao = new AccDAO();
        Account s = dao.getAccByID(accID);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("data", a.getUserName());
        AccDAO dao = new AccDAO();
        dao.updateAcc(saccID, sname, spass, semail, sfullName, sisadmin);

        response.sendRedirect("load_admin");
    }
